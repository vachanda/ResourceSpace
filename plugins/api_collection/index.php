<?php
$site_root = '/Users/hansika/Sites/ResourceSpace_7_4_7249';
$api=true;
...
echo $collection, "adkjbadkj";
$collection=str_replace('"', '', $collection);
if(!strcmp($collection, 'all')){
  // get all collections
  ...
  $particular_collection=sql_query("select c.*, u.fullname, u.username from collection c left outer join user u on u.ref = c.user where c.name='$collection'");
  print json_encode($particular_collection);
